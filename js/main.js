...
!function (e) {
    "use strict";
    var t = e(window), n = e(document), i = e("body"), a = e(".pie-chart"), o = e("#site-header"), s = e(".counter"),
        r = e(".crumina-countdown"), l = e(".crumina-countdown-number"), c = e(".crumina-skills-item"),
        d = e("#primary-menu"), u = e("#hellopreloader");
    ...
    CRUMINA.preloader = function () {
        ...
        o.headroom({offset: 10, tolerance: 5, classes: {initial: "animated", pinned: "slideDown", unpinned: "slideUp"}})
        ...
        e(".sorting-container").each((function () {
            var t = e(this), n = t.data("layout").length ? t.data("layout") : "masonry";
            t.isotope({
        ...
        a.length && a.each((function () {
            jQuery(this).waypoint((function () {
                var t = e(this.element), n = t.data("start-color"), i = t.data("end-color"), a = 100 * t.data("value");
                t.circleProgress({
                    thickness: 16,
        ...
        $swipers: {}, init: function () {
            ...
            e(".swiper-container").each((function (n) {
                var i = e(this), a = "swiper-unique-id-" + n;
            ...
            return n.slidesPerView > 1 && (n.breakpoints = {
                ...
                769: {slidesPerView: n.slidesPerView, slidesPerGroup: n.slidesPerView}
            }), n
        }, addEventListeners: function (t) {
            var n = this, i = t.$el.closest(".crumina-module-slider");
            ...
            thumbsParent: function (e, t) {
                ...
                var a = t.find(".swiper-time-line").attr("id"), o = n.$swipers[a];
                o.slideTo(i), n.changes.timeLine(o, t, n, i)
            }, timeLine: function (e, t, n, i) {
                var a = e.$el.find(".swiper-slide"), o = a.eq(i);
        ...
        t.select2({templateResult: m}), t.on("select2:select", (function (e) {
            var t = e.params.data, n = jQuery(t.element);
    ...
    e(".custom-dropdown").on("click", "li:not(.init)", (function () {
        ...
        $links: null, init: function () {
            ...
            this.removeEventListeners(), CRUMINA.isTouch() ? (e(document).on("click.menu", (function (n) {
                ...
                var n = e(this), i = n.find(".sub-menu");
        ...
        var t = [], n = 0, i = [{name: "MarketCap", color: "#3a3e48"}, {name: "Ethereum", color: "#2a2e36"}, {
            name: "WOOX",
            color: "#ffba00"
        }];
        CRUMINA.elementChart = function () {
                    ...
                    e(this).attr("id", n), Highcharts.stockChart(n, {
                        ...
                        rangeSelector: {
                            buttons: [{type: "day", count: 1, text: "1d"}, {
                                ...
                                count: 3,
                                text: "3m"
                            }, {type: "year", count: 1, text: "1y"}, {type: "all", text: "All"}], inputEnabled: !1
                        },
                        navigator: {enabled: !1},
                        scrollbar: {enabled: !1},
                        xAxis: {lineColor: "#21232b", gridLineColor: "#21232b", gridLineWidth: 1},
                        yAxis: {
                            min: 0,
                        ...
                        plotOptions: {series: {compare: "value", showInNavigator: !0, lineWidth: 4, colorIndex: 20}},
                        tooltip: {
            ...
            e.getJSON("json/" + o.name.toLowerCase() + "-c.json", (function (e) {
                t[a] = {name: o.name, data: e, color: o.color}, (n += 1) === i.length && CRUMINA.elementChart()
            }))
        }))
        ...
        function t(e) {
            e.draw(20, 380, .1, {
                callback: function () {
                    !function (e) {
                        e.draw(200, 200, .3, {easing: ease.ease("bounce-out", 1, .3)})
                    }(e)
                }
            })
        }
                ...
                easing: ease.ease("elastic-in", 1, .3), callback: function () {
                    !function (e) {
                        e.draw("20% - 240", "20%", .3, {
                            callback: function () {
                                !function (e) {
                                    e.draw(80, 320, .7, {easing: ease.ease("elastic-out", 1, .3)})
                                }(e)
                            }
                        })
                    }(e)
        ...
        var i = document.getElementById("pathD"), a = document.getElementById("pathE"),
            o = document.getElementById("pathF"), s = new Segment(i, 80, 320), r = new Segment(a, 80, 320),
            l = new Segment(o, 80, 320), c = document.getElementById("menu-icon-wrapper"),
            d = document.getElementById("menu-icon-trigger"), u = !0;
        ...
        maps: {
            mapMain: {
                config: {
                    ...
                    icon: {iconSize: [70, 87], iconAnchor: [22, 94], className: "icon-map"},
                    cluster: {iconSize: [40, 40]}
                }, markers: [{coords: [-37.813611, 144.963056], icon: "marker-google.png"}]
            }
        }, init: function () {
            for (var e in this.maps) {
                var t = this.maps[e];
                if (t.config && t.markers && document.getElementById(t.config.id)) {
                    var n = new L.map(t.config.id, t.config.map), i = L.markerClusterGroup({
                        iconCreateFunction: function (n) {
                            var i = n.getChildCount(), a = t.config.cluster;
                    ...
                    t.markers.forEach((function (e) {
                        ...
                        var n = L.icon(t.config.icon), a = L.marker(e.coords, {icon: n});
                        i.addLayer(a)
